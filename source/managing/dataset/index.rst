...
Datatsets serve another important role, they track and isolate the pedigree of your data. This means different things to different
...
it availble in proximity to the annotations you produce. 

Some datasets are contextual and need to be annotated as such. Dialog data is an example, in which annotators annotate messages seperatly but need
