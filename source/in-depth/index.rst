...
status to deactive by pressing the button as shown below. To reactivate the task simply click again. 
...
so you can use this feature to set a queue or to make sure that rush work will be done imediately. 
